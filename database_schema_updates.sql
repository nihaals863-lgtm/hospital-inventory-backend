...
-- Add source_type to inventory_facility for tracking manual entries
ALTER TABLE `inventory_facility` 
ADD COLUMN `source_type` ENUM('warehouse', 'external') DEFAULT 'warehouse' AFTER `batch_number`;
